...
class HAN(Model):
    ...
    def build_word_encoder(self):
        ...
        """
        sent_input = Input(shape=(self.max_sent_length,128,), dtype='float32')
        ...
        word_encoder = TimeDistributed(Dense(DENSE_SIZE))(sent_input)
 ...
 #       dense_sent = TimeDistributed(Dense(DENSE_SIZE))(encoded_sent)
        ...
        word_att = Attention(name='word_attention')(word_encoder)
    ...
    def build_sent_encoder(self):
        ...
        text_input = Input(shape=(self.max_sent_num, self.max_sent_length,128,), dtype='float32')
 ...
 #       sent_encoder=TimeDistributed(Dense(DENSE_SIZE))(text_input)
    ...
    def build_model(self):
        ...
        """
        doc_input = Input(shape=(self.max_doc_num, self.max_sent_num ,self.max_sent_length,128), dtype='float32')
    ...
    def train_model(self, checkpoint_path, X_train, y_train, X_val, y_val, X_test, y_test,
        ...
        print('test loss, test acc:', results)
        return results, precision, recall, f1, auc, matrix
